...
export function calculateAngle(a, b, c) {
  ...
  export function trackPushUps(landmarks) {
    ...
    return { count: pushupCount, angle: Math.round(elbowAngle) };
  }
  
  let squatCount = 0;
  let squatState = "up";
  
  export function trackSquats(landmarks) {
    ...
    return { count: squatCount, angle: Math.round(kneeAngle) };
  }
  */